...
// Gap (Non-AI): No marketplace (selling prints, products)
// No marketplace (selling prints, products)
import React, { useState } from 'react';

export default function GapNoMarketplaceSellingPrintsProductsPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-marketplace-selling-prints-products/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No marketplace (selling prints, products)</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No marketplace (selling prints, products)</p>
